...
* **Part A**: Technical Skill BuildingPlatform Used: HackerRank.Activity Description: I engaged with the HackerRank platform to complete a foundational Python introductory challenge. This exercise was designed to build my comfort level with browser-based IDEs and basic algorithmic logic & essential skills for any student in a technical branch.

**Evidence of Completion**: screenshot of the successful test case results and completion badge, titled hackerrank-completion.png, is included in the task-3-platforms/ folder.
